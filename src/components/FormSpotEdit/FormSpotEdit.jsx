...
//       try {
//         const response = await axios.get(`${apiBaseUrl}/destinos/${id}`, {
//           headers: {
//             authorization: token,
//           },
//         });
...
//     const token = localStorage.getItem("token");
//     if (!token) {
//       alert("Você precisa estar logado para editar este local.");
//       return;
//     }

//     try {
//       // if (token !== spot.usuario_id) {
//       //   alert("Você não tem permissão para editar este local.");
//       //   return;
//       // }

//       const dataSpots = {
//         usuario_id: spot.usuario_id, // Mantenha o ID do usuário atual
//         nome_do_destino: data.name, // Nome do destino
//         descricao: data.description, // Descrição
//         localidade: data.address, // Endereço/localidade
//         cep: data.cep, // CEP
//         coordenadas_geograficas: JSON.stringify({ // Formato correto para coordenadas
//           lat: data.latitude,
//           lon: data.longitude,
//         }),
//       };
//       console.log("Dados enviados para a API:", dataSpots);

//       await axios.put(`${apiBaseUrl}/destinos/${id}`, dataSpots, {
//         headers: {
